...
public class Hair_danju implements Serializable{
	...
	private String danju_code;//单据的单号
	...
	public String getDanju_code() {
		return danju_code;
	}
	public void setDanju_code(String danju_code) {
		this.danju_code = danju_code;
	}
	@Override
	public String toString() {
		return "Hair_danju [danju_id=" + danju_id + ", danju_name="
				+ danju_name + ", danju_code=" + danju_code
				+ ", danju_message=" + danju_message + ", danju_price="
				+ danju_price + ", danju_applicant=" + danju_applicant
				+ ", danju_applicant_id=" + danju_applicant_id
				+ ", danju_deal=" + danju_deal + ", danju_deal_code="
				+ danju_deal_code + ", danju_isConfirm=" + danju_isConfirm
				+ ", danju_invalid=" + danju_invalid + ", danju_isVip="
				+ danju_isVip + ", customer_phone=" + customer_phone
				+ ", customer_name=" + customer_name + ", danju_storesCode="
				+ danju_storesCode + ", danju_createTime=" + danju_createTime
